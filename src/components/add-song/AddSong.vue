  ...
  <transition name="slide">
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="search-box-wrapper">
        <search-box ref="searchBox" @searchTxtChange="searchTxtChange" placeholder="搜索歌曲" ></search-box>
      </div>
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          ...
          <scroll :refreshDelay="refreshDelay" ref="searchList" v-if="currentIndex===1" class="list-scroll"
                  :data="searchHistory">
            <div class="list-inner">
              <search-list @deleteItem="deleteSearchTxt" @selectItem="addQuery" :searches="searchHistory"></search-list>
            </div>
          </scroll>
        </div>
      </div>
      <div class="search-result" v-show="query">
        <suggest :query="query" :showSinger="showSinger" @selectSuggestItem="selectSuggestItem" @beforeScrollStart="blurInput"></suggest>
      </div>
      <!-- <top-tip ref="topTip">
        <div class="tip-title">
          <i class="icon-ok"></i>
